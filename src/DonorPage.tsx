...
class DonorPage extends Component<{ Donor: DonorDetails; Logout: () => void }> {
  state = {
    ...
    phoneNumber: this.props.Donor.PhoneNumber,
    orders: this.props.Donor.orders,
    email: this.props.Donor.email,
    selectedPlot: JSON.parse("[]"),
    plots: [],
    electricity: 0,
    travelKM: 0,
    vehicle: "Car",
  ...
  reloadAvailablePlots() {
    axios
      .get("http://in-gps2508a:5001/api/v1/plots/getAvailablePlots")
      .then((response) => this.setState({ plots: response?.data?.sender }));
  }
  render() {
    return (
      <div className={this.props.Donor.isAdmin ? "Admin" : "Donor"}>
        <div
          style={{ backgroundColor: "#e6fcf5", height: "100px", width: "100%" }}
        >
          <img
          ...
          >
            <Tabs
              ...
              onChange={(event: React.SyntheticEvent, newtab: number) => {
                if (newtab === 2) {
                  this.reloadAvailablePlots();
                  //axios.get("http://in-gps2508a:5001/api/v1/plots/getAvailablePlots").then((response)=>this.setState({plots:response?.data?.sender}))
                }
                if (newtab === 1) {
                  axios
                    .get(
                      `http://in-gps2508a:5001/api/v1/subscriber/${this.state.phoneNumber}`
                    )
                    .then((response) =>
                      this.setState({
                        orders: response.data?.data?.subscriberTrees,
                      })
                    );
                }
              ...
              <div className="TabData container">
                <div className="my-impact-main-flex">
                  ...
                  <div className="my-impact-results">
                    ...
                    >
                      Statistics modelled per your investement
                    </p>
                    ...
                    <div className="my-impact-exact-results">
                      ...
                      <div>
                        ...
                        <p className="my-impact-exact-results-main-text">
                          Kg CO2 will be removed from Atmosphere this year.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            {this.state.tab == 1 && !this.state.editProfile && (
              <div className="TabData">
                {this.state.orders?.length > 0 &&
                  this.state.orders?.map((e: any) => (
                    <div className="Plotscontainer">
                      <div className="cta">
                        <div className="cta-img-box" role="img"></div>
                        <div className="cta-text-box">
                          <h2 className="heading-secondary">Know Your Tree</h2>
                          <div className="cta-plot-info">
                            <div
                              className="combination-of-label-and-dropdown"
                              style={{ justifyContent: "unset" }}
                            >
                              <label className="cta-label">
                                Locate This Tree
                              </label>{" "}
                              <label className="locateIcon">
                                <MyLocationIcon
                                  onClick={() => window.open(e?.PlotAddress)}
                                >
                                  Loc
                                </MyLocationIcon>
                              </label>
                            ...
                            <div className="combination-of-label-and-dropdown">
                              ...
                              <label className="cta-label">
                                Planted On: {e?.PlantedOn}
                              </label>
                            </div>

                            <div className="combination-of-label-and-dropdown">
                              <label className="cta-label">
                                Amount Invested: {1500 + 2000}
                              </label>
                            </div>

                            <div className="combination-of-label-and-dropdown">
                              <label className="cta-label">
                                CO2 Reduction: 10.2 Kg till date
                              </label>
                            </div>
                          </div>
                        </div>
                ...
                {this.state.orders?.length === 0 && (
                  <div>
                    You Havent ordered Yet. Find a tree and lets save some CO2
                  </div>
                )}
              </div>
            )}
            {this.state.tab == 2 && !this.state.editProfile && (
              <div className="TabData">
                {this.state.selectedPlot?.length > 0 && (
                  <div className="Plotscontainer">
                    <div className="cta">
                      <div
                      ...
                      <div className="cta-text-box">
                        <h2 className="heading-secondary">
                          Know the information of the plots
                        </h2>
                        <div className="cta-plot-info">
                          <div
                            className="combination-of-label-and-dropdown"
                          ...
                          >
                            ...
                            <label className="locateIcon">
                              <MyLocationIcon
                                onClick={() =>
                                  window.open(
                                    this.state.selectedPlot[0]?.PlotAddress
                                  )
                                }
                              >
                                Loc
                          ...
                          <div className="combination-of-label-and-dropdown">
                            <label className="cta-label">
                              Number of Trees planted Here:{" "}
                              {parseInt(
                                this.state.selectedPlot[0]?.TreeCount?.toString()
                              ) -
                                parseInt(
                                  this.state.selectedPlot[0]?.AvailableTreeCount.toString()
                                )}
                              /{this.state.selectedPlot[0]?.TreeCount}
                            </label>
                          ...
                          <div className="combination-of-label-and-dropdown">
                            <label className="cta-label">
                              Number of Trees Yet to be planted Here:{" "}
                              {this.state.selectedPlot[0]?.AvailableTreeCount}
                            </label>
                          </div>

                          <div className="combination-of-label-and-dropdown">
                            <label className="cta-label">
                              Plot Size: {this.state.selectedPlot[0]?.PlotArea}
                            </label>
                          </div>
                          <div className="combination-of-label-and-dropdown">
                            <label className="cta-label">
                            ...
                            <input
                              ...
                              onChange={(e) =>
                                this.setState({ NumberofTrees: e.target.value })
                              }
                            />
                          </div>
                          <div className="combination-of-label-and-dropdown">
                          ...
                          <div className="combination-of-label-and-dropdown">
                            <label className="cta-label">
                              Average monthly Reduction of CO2 :{" "}
                              {this.state.NumberofTrees * 500}
                            </label>
                          </div>
                          <div className="combination-of-label-and-dropdown">
                            <label className="cta-label">
                              Average Cost of Planting:{" "}
                              {this.state.NumberofTrees * 1500}
                            </label>
                          </div>
                          <div className="combination-of-label-and-dropdown">
                            <label className="cta-label">
                              Average monthly Maintanace cost for :{" "}
                              {this.state.NumberofTrees * 500}
                            </label>
                          </div>
                        </div>
                      ...
                      <Button
                        onClick={() => {
                          axios
                            .post(
                              "http://in-gps2508a:5001/api/v1/plots/PurchasePlot",
                              {
                                numberofTrees: this.state.NumberofTrees,
                                plotId: this.state.selectedPlot[0]?.PlotId,
                                mobileNumber: this.state.phoneNumber,
                                treeType: this.state.treeType,
                              }
                            )
                            .then(() => this.reloadAvailablePlots());
                          this.setState({ selectedPlot: [] });
                        }}
                      >
                        Buy
                      </Button>
                ...
                {this.state.plots?.length > 0 &&
                  !(this.state.selectedPlot?.length > 0) &&
                  this.state.plots?.map((e: any) => (
                    <div
                      className="Plotscontainer"
                      onClick={() => this.setState({ selectedPlot: [e] })}
                    >
                      <div className="cta">
                        <div
                          className="cta-img-box"
                        ...
                        <div className="cta-text-box">
                          <h2 className="heading-secondary">
                            Know the information of the plot
                          </h2>
                          <div className="cta-plot-info">
                            <div
                              className="combination-of-label-and-dropdown"
                            ...
                            <div className="combination-of-label-and-dropdown">
                              <label className="cta-label">
                                Number of Trees planted Here:{" "}
                                {parseInt(e?.TreeCount?.toString()) -
                                  parseInt(e?.AvailableTreeCount.toString())}
                                /{e?.TreeCount}
                              </label>
                              <label className="cta-label"></label>
                            </div>
                ...
                <div className="various-pollution-flex">
                  <div className="electricity-pollution-flex">
                    ...
                    <div>
                      <div className="electricity-flex">
                        <label className="label-class">
                          Average electricity Units Consumed in a month
                        </label>
                        <input
                          type="text"
                          ...
                          onChange={(e) =>
                            this.setState({ electricity: e.target.value })
                          }
                        />
                      </div>
                    </div>
                    <div>
                      <div className="total-value-grouped">
                        <label className="label-class label-class-inline">
                          A total of{" "}
                        </label>
                        <label className="label-class label-class-inline">
                          {this.state.electricity * 0.85}
                        </label>
                        <label className="label-class label-class-inline">
                          {" "}
                          kgs CO2 is getting released monthly due to your power
                          usage.
                        </label>
                      </div>
                    </div>
                  ...
                  <div className="electricity-pollution-flex">
                    ...
                    <div className="travel-flex">
                      <label className="label-class">
                        Average Distance travelled by you per day
                      </label>
                      <input
                        type="text"
                        className="input-class"
                        value={this.state.travelKM}
                        onChange={(e) =>
                          this.setState({ travelKM: e.target.value })
                        }
                      />
                    </div>

                    <div className="travel-flex-down">
                      <label className="label-class">Vehicle Type</label>
                      <select
                        name="areas"
                    ...
                    <div>
                      <div className="total-value-grouped">
                        ...
                        <label className="label-class label-class-inline">
                          {(Math.round(
                            this.state.vehicle == "Car"
                              ? this.state.travelKM * 1.22
                              : this.state.travelKM * 1.5
                          ) *
                            300) /
                            100}
                        </label>
                        <label className="label-class label-class-inline">
                          {" "}
                          Kgs of CO2 is getting released monthly due to usage of
                ...
                <div className="ProfileData">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      axios
                        .post(
                          "http://in-gps1571a:5001/api/v1/subscriber/AddSubscriber",
                          {
